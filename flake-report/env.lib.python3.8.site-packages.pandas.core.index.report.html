...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.8/site-packages/pandas/core/index.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.8.site-packages.pandas.core.index.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env/lib/python3.8/site-packages/pandas/core/index.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.8.site-packages.pandas.core.index.source.html#l26">
