...
# data_file created to easily update data file with json module
...
if __name__=="__main__":
    ...
    """ Saving Data """
    def save_players_data1():
        """ save players data """
        # db = TinyDB('tournament_data.json')
        # players table: 't_players'
    ...
    def update_players_data():
        """ save players data """
        # use of json for update operations
